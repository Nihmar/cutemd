...
class PreviewWebEngineView(QWebEngineView):
    ...
    _KATEX_JS = (
        ...
        "console.log('cutemd: katex batch '+entries.length+' intersecting, scrollY='+sy0+' scrollH='+sh0);"
        ...
        "});"
        "console.log('cutemd: katex done, scrollY='+sy0+'->'+window.scrollY+' scrollH='+sh0+'->'+document.body.scrollHeight);"
        "},{rootMargin:'100px'});"
